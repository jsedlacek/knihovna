...
/**
 * Batch process multiple books for Goodreads data with concurrency control.
 */
export async function scrapeGoodreadsBatch(
  ...
  const workers = Array(concurrency).fill(null).map(processBook);
